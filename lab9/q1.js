/*Use the Module pattern to create a shopping cart that has one private member: basket[], and the following public methods:

upsertItem() add a product to basket if doesn't exist, or update if exist. - products are treated the same only if the product id is the same.
...
Every product item has the following structure:Product = {id: 0, name: 'Coffee', description: 'Coffee Grounds from Ethiopia', price: 9.5, count: 1}*/
